...
END
  ...
  it 'has a method that returns its successor' do
    string = 'abcde'
    numeric_string = '12345'

    expect(string.succ).to eq('abcdf')
    expect(numeric_string.succ).to eq('12346')
  end

  it 'has a method that strips out charcter repetitions' do
    string = 'hello'

    expect(string.squeeze).to eq('helo')
  end

  it 'has a method that will split a string in two at a seperator' do
    string = 'hello my name is'

    expect(string.partition('my')).to eq(['hello ', 'my', ' name is'])
  end

  it 'has a method that replaces specified characters in a string with corresponding characters in a new string' do
    string = 'ruby academy'

    expect(string.tr('rac', 'blu')).to eq('buby luldemy')
  end
end
